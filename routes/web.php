...
Route::get('/lupa-password', [StorefrontController::class, 'forgotPassword'])->name('password.forgot');
Route::post('/lupa-password', [StorefrontController::class, 'sendForgotPasswordOtp'])->name('password.forgot.send');
Route::get('/reset-password', [StorefrontController::class, 'resetPassword'])->name('password.reset');
Route::post('/reset-password', [StorefrontController::class, 'updateResetPassword'])->name('password.reset.update');
...
Route::prefix('admin')->middleware('admin.session')->group(function (): void {
    ...
    Route::post('/orders/{code}/recipient', [AdminController::class, 'updateRecipient'])->name('admin.orders.update-recipient');
    ...
    Route::post('/orders/{code}/restore', [AdminController::class, 'restoreOrder'])->name('admin.orders.restore');
