        ...
        <article class="rounded-[1.5rem] border border-stone-200 bg-white p-4 shadow-sm" data-variant-item data-index="${index}" data-id="${variant.id ?? ''}">
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div>
                    ...
                    <input type="text" inputmode="numeric" value="${formatThousand(variant.compare_at_price)}" class="w-full rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm outline-none focus:border-emerald-500 focus:bg-white" placeholder="0" data-variant-field="compare_at_price">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" min="0" value="${numberValue(variant.weight_grams)}" class="w-full rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm outline-none focus:border-emerald-500 focus:bg-white" placeholder="0" data-variant-field="weight_grams">
                </div>
                <div>
