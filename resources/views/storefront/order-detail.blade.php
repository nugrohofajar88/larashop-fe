            ...
            <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
                ...
                <aside class="space-y-6">
                    ...
                    <article class="rounded-3xl border border-surface-container-highest bg-surface-container-lowest p-6 soft-warm-shadow">
                        ...
                        <a href="https://wa.me/" target="_blank" rel="noopener" class="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-on-background px-5 py-3.5 font-body-md font-semibold text-on-primary transition hover:bg-primary">
